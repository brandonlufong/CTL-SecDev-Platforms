...
// Test if service loads correctly
console.log('Network detection service loaded:', typeof networkDetectionService.detectNetworkConfiguration);
  ...
  try {
    ...
    if (!Array.isArray(assets) || assets.length === 0) {
      return res.status(400).json({ 
        ...
        details: 'Please provide an array of discovered assets to import'
      });
    }
    ...
    discoveryLogger.info('Assets imported successfully', {
      details: { 
        userId: req.user.id, 
